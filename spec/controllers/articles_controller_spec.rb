...
describe ArticlesController do
  ...
  before :each do
    ...
    @result_1.stub(:find_sub_categories).and_return(@sub_category)

    @article_1 = FactoryGirl.build(:article, title: "One", id: 1)
    @article_2 = FactoryGirl.build(:article, title: "Two", id: 2)
